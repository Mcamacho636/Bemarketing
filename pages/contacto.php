<section class="Contenedor-Seccion Contenido-Portafolio" styles="margin-top:6rem;">
    ...
    <main class="Contenedor-Seccion Contenido-Contacto-Form" style="height: auto;">
        <div class="tab-contacto">
            <button class="tablinks-contacto" onclick="cambiarTab(event, 'ContactoGeneral')" id="defaultOpen">Contacto General</button>
            ...
            <form action=" " class="contacto-proyecto ">
                ...
                <fieldset>
                    ...
                    <div class="Campo-Formulario">
                        ...
                        <div>
                            <input type="checkbox" name="cb-redes-sociales " id="cb-redes-sociales " value="servicio-interes ">
    ...
    <section class="Contenedor-Seccion ">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3770.2572488276846!2d-104.32340268564081!3d19.09636728707623!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8424d52fbdb7fc1f%3A0x4ca74d0b35a856fc!2sBeMa%20%7C%20Mx!5e0!3m2!1ses!2smx!4v1600441250909!5m2!1ses!2smx "
