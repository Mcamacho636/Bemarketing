        ...
        <div class="Contenido-Nosotros">
            <div class="Tarjeta-Simple">
                ...
                <div class="Contenido-Tarjeta-Simple">
                    <h3>Lorem</h3>
                    <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Voluptas ut dignissimos ullam magni ipsam odit dicta beatae similique quos obcaecati officia, id nesciunt vel saepe ducimus, incidunt, in sint ea.</p>
                </div>
            </div>
            <div class="Tarjeta-Simple">
                <img src="Assets/Imagen1.jpeg " class="" alt="... ">
        ...
        <div class="Contenido-Trabajos">
                ...
                <div class="flip-card wow">
                    <div class="flip-card-inner">
                        ...
                        <div class="flip-card-back">
                            <h3>Lorem</h3>
                            <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Harum, unde, ducimus, expedita id impedit incidunt mollitia magnam deleniti natus velit aperiam fuga. Asperiores, ab voluptate dolores accusantium dolorem porro doloribus.</p>
                        </div>
                    </div>
                </div>
            </a>
            <a href="" class="wow animate__animated animate__backInLeft" data-wow-delay=".8s">
                <div class="flip-card">
                    <div class="flip-card-inner">
                        <div class="flip-card-front">
                            <img src="Assets/Imagen2.jpeg" alt="Avatar" style="width:300px;height:300px; border-radius: 20px;">
                        </div>
                        <div class="flip-card-back">
                            <h3>Lorem</h3>
                            <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Velit quo vel doloribus delectus? Amet veritatis numquam voluptate quaerat, architecto aspernatur repellat voluptates impedit optio ratione quos nisi, harum nobis sunt.</p>
                        </div>
                    </div>
                </div>
            </a>
            <a href="" class="wow animate__animated animate__backInLeft" data-wow-delay="0.2s">
                <div class="flip-card">
                    <div class="flip-card-inner">
                        <div class="flip-card-front">
                            <img src="Assets/Imagen3.jpg" alt="Avatar" style="width:300px;height:300px; border-radius: 20px;">
                        </div>
                        <div class="flip-card-back">
                            <h3>Lorem</h3>
                            <p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Animi sit adipisci accusantium eveniet ut at nihil pariatur officia eos nobis fugiat nulla a, odit alias. Quo aliquam hic culpa natus!</p>
                        </div>
                    </div>
                </div>
            </a>
        ...
        <div class="Carrusel-Infinito">
            <div class="slider ">
                <div class="slide-track ">
                    <div class="slide ">
                        <img src="Assets/Imagen1.jpeg " height="100 " width="250 " alt=" " />
                    </div>
                    <div class="slide ">
