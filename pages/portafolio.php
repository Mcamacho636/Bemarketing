<section class="Seccion-Contenedor Contenido-Portafolio">
    ...
    <main class="Contenedor-Seccion" style="width: 90%; height: auto;">
        ...
        <div class="tab-trabajos">
            <button class="tablinks-trabajos Boton-Amarillo" onclick="cambiarTab(event, 'Todos')" id="defaultOpen">Todos</button>
                        ...
                        <div class="flip-card">
                            <div class="flip-card-inner">
                                ...
                                <div class="flip-card-back">
                                    <h3>Lorem</h3>
                                    <p>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Harum, unde, ducimus, expedita id impedit incidunt mollitia magnam deleniti natus velit aperiam fuga. Asperiores, ab voluptate dolores accusantium dolorem porro
                                        doloribus.
                                    </p>
                                </div>
                            </div>
